...
namespace BAL
{
    public class EmailSender
    {
        ...
        public void SendEmail(object param)
        {
            ...
            if (message != null)
            {
                var emails = messages.Where(m => m.Ancestor != null && message.Ancestor != null && m.Ancestor.Id == message.Ancestor.Id && !String.IsNullOrEmpty(m.Email)).Select(m => m.Email).Distinct().ToList();
